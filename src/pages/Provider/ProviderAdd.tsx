                ...
                <form onSubmit={agregarProveedor}>
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input
                                placeholder="Ingrese el Código Postal del proveedor"
                                type="text"
                                value={postalCode}
                        ...
                        <div>
                            ...
                            <input
                                placeholder="Ingrese la localidad o comunidad del proveedor"
                                type="text"
                                value={community}
                        ...
                        <div>
                            ...
                            <input
                                placeholder="Ingrese la provincia del proveedor"
                                type="text"
                                value={province}
                        ...
                        <div>
                            ...
                            <input
                                placeholder="Ingrese el telfón del proveedor"
                                type="text"
                                value={phone}
                        ...
                        <div>
                            ...
                            <input
                                placeholder="Ingrese la pagina web del proveedor"
                                type="text"
                                value={web}
